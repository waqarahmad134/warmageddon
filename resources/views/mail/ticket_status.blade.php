                ...
                <tr>
                    <td style="padding: 0px 30px 20px 40px; color: #FFFFE4; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px; text-align: center; line-height: 26px;">
                        ...
                        <p>
                            ...
                            <br />
                             Your ticket # {{$ticket_number}} status has been updated<br />
                            Please Login to your lobby account and check status by <br />
                            going to inbox/ticket history tab : <br />
                        </p>
                    </td>
                </tr>
                <tr>
                    <td align="center">
{{--                        <a href="https://propersix.casino/user-login" type="button" class="btn btn-md" style="color: #db942e;">--}}
{{--                            Lobby--}}
{{--                        </a>--}}
                        <br />
                        <p style="color: #FFFFE4;">
                            Click on the below link to view ticket
                            <br />
                            https://propersix.casino/user-login
                        </p>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 10px 30px 10px 30px;" bgcolor="#212121">
                        <table border="0">
                            ...
                            <td style="color: #ffffff; font-family: Arial, sans-serif; font-size: 14px;" width="80%">
                                ...
                                <br>
                                <a style="color: #ffffff; font-style: italic; text-decoration: none;" href="#">
                                    Unsubscribe
                                </a>
                                from the newsletter
                            </td>
