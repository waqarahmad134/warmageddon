                ...
                <div class="col-md-6">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Deposits/Withdrawals Chart</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body text-center">
                    <button type="button" class="btn btn-success">Group by days</button>
                    <button type="button" class="btn btn-success">Group by weeks</button>
                    <button type="button" class="btn btn-success">Group by months</button>
                </div>
            </div>
        </div>
    </div>
