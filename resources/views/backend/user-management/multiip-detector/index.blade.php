                ...
                <div class="col-md-6">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Multi Login IP Detector</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header text-center">
                    <h3>Determine which users logged in from same IP on multiple accounts</h3>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="datatables-buttons" class="table table-striped">
                            ...
                            <tr>
                                ...
                                <th>Username</th>
                                <th>Login Date</th>
                                <th>Matching Username</th>
                                <th>Both usernames have logged in from IP</th>
                            </tr>
                            </thead>
                            <tbody>
                            @php
