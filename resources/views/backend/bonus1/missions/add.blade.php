                    ...
                    @csrf
                       ...
                       <h4>Rewards Info</h4><hr>
                        ...
                        <div class="form-group row" >
                            ...
                            <div class="col-md-8">
                                <input id="amount" type="number" min="0" class="form-control {{ $errors->has('wager_amount') ? ' is-invalid' : '' }}" name="wager_amount" value="{{ isset($edit) ? $edit->wager_amount : old('wager_amount') }}" required>
                        ...
                        <div class="form-group row" >
                            ...
                            <div class="col-md-8">
                                <input id="amount" type="number" min="0" class="form-control {{ $errors->has('total_spin') ? ' is-invalid' : '' }}" name="total_spin" value="{{ isset($edit) ? $edit->total_spin : old('total_spin') }}" required>
