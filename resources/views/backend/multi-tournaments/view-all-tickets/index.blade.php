                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select id="tournament" type="text" class="form-control {{ $errors->has('tournament') ? ' is-invalid' : '' }}" name="tournament" required>
                                    <option>Any tournament</option>
                                    <option>Single tournament</option>
                                </select>
                        ...
                        <table id="datatables-buttons" class="table table-striped">
                            ...
                            @for($x = 0; $x <= 80; $x++)
                                <tr>
                                    ...
                                    <td>Played</td>
                                    <td>
                                        <a href="#" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Cancel This">Cancel</a>
                                    </td>
                                </tr>
                            @endfor
                            </tbody>
