...
{{--                        @endphp--}}
                    ...
                    <div class="body">
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::text('first_name', null, array('class' => 'form-control','value'=>$user->profile->first_name)) }}
                        </div>
                        <div class="form-group">
                            {{ Form::label('name', 'Last Name') }}
                            {{ Form::text('last_name', null, array('class' => 'form-control','value'=>$user->profile->last_name)) }}
                        </div>
                        <div class="form-group row">
                            <label for="address" class="col-md-3 col-form-label">Address : </label>
                            <div class="col-md-12">
                                <input id="address" type="text" class="form-control {{ $errors->has('address') ? ' is-invalid' : '' }}" name="address" value="{{$user->profile->address!=null?$user->profile->address: old('address') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="date_of_birth" type="text" class="form-control datepicker {{ $errors->has('date_of_birth') ? ' is-invalid' : '' }}" name="date_of_birth" value="{{$user->profile->date_of_birth!=null?$user->profile->date_of_birth:old('date_of_birth') }}">
                            ...
                            <div class="col-md-12">
                                <select id="country" type="text" class="form-control select2 {{ $errors->has('country') ? ' is-invalid' : '' }}" name="country" data-toggle="select2">
                                    ...
                                    @foreach($countries as $item)
                                        <option value="{{ $item->id }}" @if($item->id==$user->profile->country) selected @endif>{{ $item->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <select id="city1" type="text" class="form-control select2 {{ $errors->has('city') ? ' is-invalid' : '' }}" name="city" data-toggle="select2">
                                    ...
                                    @endphp
                                    @foreach($countries as $item)
                                        <option value="{{ $item->id }}" @if($item->id==$user->profile->state) selected @endif>{{ $item->name }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('city'))
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="phone_number" type="text" class="form-control {{ $errors->has('phone_number') ? ' is-invalid' : '' }}" name="phone_number" value="{{ $user->profile->phone_number }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <select id="secret_question" type="text" class="form-control {{ $errors->has('secret_question') ? ' is-invalid' : '' }}" name="secret_question">
                                    <option @if($user->profile->secret_question=="What's my mother's hidden name?") selected @endif>What's my mother's hidden name?</option>
                                    <option @if($user->profile->secret_question=="What's my favourite hobby?") selected @endif>What's my favourite hobby?</option>
                                    <option @if($user->profile->secret_question=="What's my favourite sport club?") selected @endif>What's my favourite sport club?</option>
                                    <option @if($user->profile->secret_question=="What's the name of my favourite book?") selected @endif>What's the name of my favourite book?</option>
                                    <option @if($user->profile->secret_question=="Who was my childhood hero?") selected @endif>Who was my childhood hero?</option>
                                    <option @if($user->profile->secret_question=="What's the name of my pet?") selected @endif>What's the name of my pet?</option>
                                    <option @if($user->profile->secret_question=="What's my nickname?") selected @endif>What's my nickname?</option>
                                    <option @if($user->profile->secret_question=="What was the make of my first car?") selected @endif>What was the make of my first car?</option>
                                    <option @if($user->profile->secret_question=="What's my secret code?") selected @endif>What's my secret code?</option>
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                ...
                                <input id="secret_answer" type="text" class="form-control {{ $errors->has('secret_answer') ? ' is-invalid' : '' }}" name="secret_answer" value="{{$user->profile->secret_answer}}">
                        ...
                        <div id="affiliate" @if($user->roles->first()->name!="Affiliate") style="display: none;" @endif>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <input id="pro_payout_percentage" type="number" class="form-control {{ $errors->has('pro_payout_percentage') ? ' is-invalid' : '' }}" name="pro_payout_percentage" value="{{ $user->pro_payout_percentage }}">
