        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h4>Add Media Template</h4>
                        <form action="{{route('affiliate.saveTemplate')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-md-3 col-form-label text-md-right">Template Type : </label>
                                <div class="col-md-8">
                                    <select id="prize" type="text" class="form-control {{ $errors->has('prize') ? ' is-invalid' : '' }}" name="template_type" required>
                                        <option value="Graphics">Graphics</option>
                                        <option value="Marketing Templates">Marketing Templates</option>
                                        <option value="Marketing Text">Marketing Text</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select id="prize" type="text" class="form-control {{ $errors->has('prize') ? ' is-invalid' : '' }}" name="file_type" required>
