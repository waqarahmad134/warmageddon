                ...
                <div class="col-md-6">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Promo Account Summary Report</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header text-center">
                    <h3>Promo Account Summary Report</h3>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="datatables-buttons" class="table table-striped">
                            ...
                            <tr>
                                ...
                                <th>Beginning balance for promotional play</th>
                                <th>Total amount of awards</th>
                                <th>Total Amount Used (that became cashable)</th>
                                <th>Total Amount Expired</th>
                                <th>Total adjustment amount</th>
                                <th>Ending balance by promotion</th>
                            </tr>
                            </thead>
                            <tbody>
                            @php
