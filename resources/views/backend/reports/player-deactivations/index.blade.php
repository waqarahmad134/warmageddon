                ...
                <div class="col-md-6">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Player Deactivations Report</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header text-center">
                    <h3>Player Deactivations Report</h3>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="datatables-buttons" class="table table-striped">
                            ...
                            <tr>
                                <th>ID</th>
                                <th>Unique Player id</th>
                                <th>Player name</th>
                                <th>Date of disabled/deactivation start</th>
                                <th>Date of disable/deactivation end</th>
                                <th>Staff ID who Started deactivation</th>
                                <th>Staff ID who Ended deactivation</th>
