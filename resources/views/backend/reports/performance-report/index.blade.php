                ...
                <div class="col-md-6">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Gaming Performance Report</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header text-center">
                    <h3>Gaming Performance Report</h3>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="datatables-buttons" class="table table-striped">
                            ...
                            <tr>
                                <th>Game ID</th>
                                <th>Game Name</th>
                                <th>Total wagered Amount</th>
                                <th>Total Win Amount</th>
                                <th>Total contribution to progressive pool</th>
                                <th>Total Amount Refunded</th>
                                <th>Total Funds in incomplete games</th>
                            </tr>
                            </thead>
                            <tbody>
                            @php
