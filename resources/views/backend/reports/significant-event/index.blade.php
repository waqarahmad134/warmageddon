                ...
                <div class="col-md-6">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Significant Event Report</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select id="type" type="text" class="form-control {{ $errors->has('type') ? ' is-invalid' : '' }}" name="type" required>
                                    <option>List all events</option>
                                    <option>Failed login Attempts</option>
                                    <option>Significant unavailability</option>
                                    <option>Large wins</option>
                                    <option>Large transfers</option>
                                    <option>System voids</option>
                                    <option>Player acc. deactivations</option>
                                    <option>Sessions Closed due to inactivity</option>
                                    <option>Others requiring staff interv</option>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header text-center">
                    <h3>Significant Event Report</h3>
                </div>
                <div class="card-body">
