                ...
                <div class="col-md-6">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Player Account Exclusions Report</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header text-center">
                    <h3>Player Account Exclusions Report</h3>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="datatables-buttons" class="table table-striped">
                            ...
                            <tr>
                                ...
                                <th>Player name</th>
                                <th>Type of exclusion</th>
                                <th>Date of exclusion Start</th>
                                <th>Date of exclusion End</th>
                                <th>Exclusion Status</th>
                                <th>Reason</th>
                                <th>Number of times the player was excluded</th>
                            </tr>
                            </thead>
                            <tbody>
                            @php
