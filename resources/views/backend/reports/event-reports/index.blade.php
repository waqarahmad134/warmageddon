                ...
                <div class="col-md-6">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Significant Event Sum.Report</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header text-center">
                    <h3>Significant Event Sum.Report</h3>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="datatables-buttons" class="table table-striped">
                            <thead>
                            <tr>
                                <th>Failed system side login attempts</th>
                                <th>Significant periods of unavailability (over 1h)</th>
                                <th>Large wins in excess (over 5000.000$)</th>
                                <th>Large transfer of funds in excess (over 2500.00$)</th>
                                <th>System voids, overrides and corrections</th>
                                <th>Mandatory deactivation of player account</th>
                                <th>How many times website entered maintenance mode</th>
                            </tr>
                            </thead>
                            <tbody>
                            @php
