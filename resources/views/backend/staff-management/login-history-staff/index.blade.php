                ...
                <div class="col-md-6">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Login History Staff</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="datatables-buttons" class="table table-striped">
                            ...
                            @foreach ($loginHistoryStaff as $key => $item)
                                <tr>
                                    <td>78{{ $key+1 }}</td>
                                    <td>{{$item->user->profile->username}}</td>
                                    <td>{{$item->uaer?$item->uaer->ip_address:''}}</td>
                                    <td>{{$item->user? $item->user->last_login_ip:''}}</td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
