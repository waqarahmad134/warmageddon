                ...
                <div class="col-md-6">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Prizes List all prizes</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <div class="form-group row">
                            <label for="prize_id" class="col-md-3 col-form-label text-md-right">Prize ID : </label>

                            <div class="col-md-8">
                                <input id="prize_id" type="text" class="form-control {{ $errors->has('prize_id') ? ' is-invalid' : '' }}" name="prize_id" value="{{ old('prize_id') }}" required>
                                @if ($errors->has('prize_id'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('prize_id') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
