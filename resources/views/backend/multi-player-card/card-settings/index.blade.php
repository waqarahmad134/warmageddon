            ...
            <div class="card p-4">
                ...
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select id="select_room" type="text" class="form-control {{ $errors->has('select_room') ? ' is-invalid' : '' }}" name="select_room" required>
                                    <option>1. Room Small Bets </option>
                                    <option>2. Room Big Bets</option>
                                </select>
                        ...
                        <!-- Start rake_percentage -->
                        <div class="form-group row">
                            <label for="rake_percentage" class="col-md-3 col-form-label text-md-right">*Max Bet : </label>

                            <div class="col-md-8">
                                <div class="input-group">
                                    <input id="rake_percentage" type="text" class="form-control {{ $errors->has('rake_percentage') ? ' is-invalid' : '' }}" name="rake_percentage" value="{{ old('rake_percentage') }}" required>
                                    <span class="input-group-append">
                                        <button class="btn btn-secondary" type="button"> $ </button>
                                    </span>
                                </div>
                                @if ($errors->has('rake_percentage'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('rake_percentage') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
