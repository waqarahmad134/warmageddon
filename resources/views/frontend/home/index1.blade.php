                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="gettingstart-box text-center wow fadeInLeft" data-wow-delay=".3s" data-wow-offset="30" data-wow-duration="1s">
                            <p>{{$data->welcome_text!=null?$data->welcome_text:'ProperSix Casino has an awesome game collection'}}</p>
                            <h4>{{$data->welcome_heading!=null?$data->welcome_heading:'Sign up now and become a member of the propersix gaming world'}}</h4>
                        </div>
                    </div>
                    <div class="col-md-3">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="game-showcase-header all-header">
                        ...
                        <p>ENJOY THE MOST AMAZING GAMES OF PROPERSIX CASINO!</p>
                ...
                <div class="col-sm-12">
                    <div class="game-showcase-box">
                        <ul id="filters" class="clearfix controls">
                            ...
                            @endforeach
                            <li>
                                <p class="filter" data-filter=".softswiss">
                                    <img src="{{ asset('softswiss-games/softswiss_logo.png') }}" alt="">
                                    <span>Softswiss</span>
                                </p>
                            </li>
                        </ul>
                        ...
                        <div  id="gallery"  class="wow bounceInUp" data-wow-delay=".3s" data-wow-offset="20" data-wow-duration="1s">
                            ...
                            @foreach($games_category as $cat)
                                ...
                                @endif
                            @endforeach
{{--                                <div class="gallery-item hovereffect softswiss" data-cat="softswiss">--}}
                                    @foreach($softswiss_games as $item)
                                        @if($item->id>1)
                                        <div  class="gallery-item softswiss hovereffect" data-cat="softswiss">
                                            <div class="inside">
                                                <div class="gall-overlay"></div>
                                                <div class="overlay">
                                                    <div class="text">
                                                        <a href="{{ url('game/play-demo/'.$item->id) }}"  class="btn">Play Demo</a>
                                                        <a href="{{ url('game/play/'.$item->id) }}"  class="btn">Play Real</a>
                                                    </div>
                                                </div>
                                                <img src="{{'https://cdn.softswiss.net/i/s4/'.$item->provider.'/'.$item->title.'.png'}}" alt="all" class="img-fluid">
                                                {{--                                            @if (@Auth::check())--}}
            ...
            <div class="row">
                <div class="col-lg-7 m-auto">
                    <div class="top-winner-text">
                        <h3>{{$data->winner_heading!=null?$data->winner_heading:'Top winners of the day'}}</h3>
                        <table class="all-table table table-borderless table-striped table-hover table-dark wow bounceIn" data-wow-delay=".3s" data-wow-offset="30" data-wow-duration="1s">
                            ...
                            <tr>
                                ...
                                <td>{{$data->winner_theading2!=null?$data->winner_theading2:'Date'}}</td>
                                <td>{{$data->winner_theading3!=null?$data->winner_theading3:'Amount'}}</td>
                            </tr>
                            @if(!empty($winners))
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="footer-bottom-box mb-0 wow fadeIn" style="background: #000000; " data-wow-delay=".9s" data-wow-offset="30" data-wow-duration="1s">
                        <h5>{{$data->promotion1_heading2!=null?$data->promotion1_heading2:'Casino White Label Platform'}}</h5>
                        {!!$data->promotion1_text2!=null?$data->promotion1_text2:'<p>Our technology allows a game developer to create a front-end system that then runs on one of ProperSix back-end platforms without the need to understand the complexity of building a complete gaming platform. This will radically disrupt the traditional model where the established gaming companies provide the end to end service and do not provide an audit trail for the transactions or random number.</p><a href="/contact-us" style="color: #e2a236;position:relative; z-index:10;">Contact us for more info</a>'!!}
