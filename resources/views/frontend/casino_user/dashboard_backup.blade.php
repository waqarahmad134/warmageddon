                            ...
                            <div class="row">
                                <div class="col-xl-4 tab-outer">
                                    ...
                                    <div class="tab" id="content-tab-z">
                                        <button class="tablinks my-ml" onclick="openCity(event, 'Mission')" @if(Request::url()==request()->getSchemeAndHttpHost().'/user/dashboard' && (!Session::has('setting_tab') && !Session::has('inbox_tab') && !Session::has('banking_tab'))) id="defaultOpen"  @endif @if((Request::url()==request()->getSchemeAndHttpHost().'/user/deposit' || Session::has('banking_tab')) && (!Session::has('setting_tab') && !Session::has('inbox_tab'))) id="defaultOpen" @endif>
