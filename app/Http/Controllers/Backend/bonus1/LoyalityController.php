...
class LoyalityController extends Controller
{
    function index(){
        try {
            ...
            return view('backend.bonus.loyality.index',compact('data'));
        } catch (\Exception $e) {
    ...
    function loyality_add(){
        try {
            return view('backend.bonus.loyality.add');
        } catch (\Exception $e) {
            Toastr::error('Something went wrong! Try again');
            return redirect()->back();
        }
    ...
    function loyalty_Edit($id){
        try {
            ...
            return view('backend.bonus.loyality.add', compact('edit'));
        } catch (\Exception $e) {
            Toastr::error('Something went wrong! Try again');
            return redirect()->back();
        }
    ...
    function general_setting(){
        try {
            ...
            return view('backend.bonus.loyality.general_setting', compact('loyalSettings'));
        } catch (\Exception $e) {
            Toastr::error('Something went wrong! Try again');
            return redirect()->back();
        }
    ...
    function settng_Edit($id){
        try {
            ...
            return view('backend.bonus.loyality.general_setting', compact('loyalSettings','edit'));
        } catch (\Exception $e) {
            Toastr::error('Something went wrong! Try again');
            return redirect()->back();
        }
