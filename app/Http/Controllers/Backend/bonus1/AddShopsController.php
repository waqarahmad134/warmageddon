...
class AddShopsController extends Controller
{
    ...
    public function PurchaseItems()
    {
        ...
        return view('backend.bonus.list-shops.purchasedItems',compact('purchased_items'));
    }
    public function create()
    {
        $loyalty = Loyality::where('status' , '1')->get();
        return view('backend.bonus.add-shops.index' , compact('loyalty'));
    }
    ...
    public function edit($id)
    {
        ...
        $loyalty = Loyality::where('status' , '1')->get();
        return view('backend.bonus.add-shops.index', compact('edit' , 'loyalty'));
    }
