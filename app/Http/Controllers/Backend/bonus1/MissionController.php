...
class MissionController extends Controller
{
    function missionList(){
        try {
            ...
            return view('backend.bonus.missions.list', compact('data'));
        } catch (\Exception $e) {
    ...
    public function usermission()
    {
        ...
        return view('backend.bonus.missions.userMissions',compact('user_missions'));
    }
    function create(){
        $type = MisssionType::latest()->get();
        return view('backend.bonus.missions.add',compact('type'));
    }
    ...
    function show($id){
        ...
        return view('backend.bonus.missions.show', compact('mission'));
    }
    function edit($id){
        $edit = MissionBonus::find($id);
        $type = MisssionType::latest()->get();
        return view('backend.bonus.missions.add', compact('edit','type'));
    }
    ...
    function mission_type(){
        try {
            ...
            return view('backend.bonus.missions.missionType', compact('data'));
        } catch (\Exception $e) {
            Toastr::error('Something went wrong. Please try again. ','Error');
            return redirect()->back();
        }
    ...
    function mission_type_create(){
        try {
            return view('backend.bonus.missions.add_mission_type');
        } catch (\Exception $e) {
            Toastr::error('Something went wrong. Please try again. ','Error');
            return redirect()->back();
        }
    ...
    function mission_type_edit($id){
        try {
            ...
            return view('backend.bonus.missions.add_mission_type',compact('edit'));
        } catch (\Exception $e) {
            Toastr::error('Something went wrong. Please try again. ','Error');
            return redirect()->back();
        }
