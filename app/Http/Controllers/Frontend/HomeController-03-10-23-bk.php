...
//         $history->connection      = $json->connection;
    ...
    public function index1(Request $request) {
        ...
        $softswiss_games = SoftswissGames::all();
...
";
        ...
        if (Auth::user()) {
            ...
            //$data = 'home';
            return view('frontend.home.index1', compact('data','user','share','all','winners','games_category','softswiss_games'));
        }else {
            //$data = 'home';
            return view('frontend.home.index1', compact('data','all','winners','games_category','softswiss_games'));
        }
...
// ";
    ...
    public function referral_registration()
    {
        ...
        {
            return redirect('/#popup-signup')->with('ref_key',Session::get('ref_key'));
        }
      else
      {
          return redirect('/#popup-signup');
